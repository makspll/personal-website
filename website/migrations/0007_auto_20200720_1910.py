...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('website', '0006_auto_20200720_1719'),
    ]

    operations = [
        migrations.AddField(
            model_name='header',
            name='include_slide_down_sign',
